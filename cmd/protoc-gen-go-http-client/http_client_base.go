...
const httpClientBaseCode = `// Code generated by protoc-gen-go-http-client. DO NOT EDIT.

// Package http provides a reusable HTTP client for JSON-encoded proto messages.
//
